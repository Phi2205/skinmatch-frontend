...
type IngredientFormData = zod.infer<typeof ingredientSchema>;
...
export function UpdateIngredientModal({ isOpen, onClose, ingredient }: UpdateIngredientModalProps) {
  ...
  const mutation = useMutation({
    mutationFn: (data: IngredientFormData) => {
      ...
      return updateIngredient(ingredient.id, data);
    },
    onSuccess: (response) => {
      if (response.success) {
